...
- Closeout (2026-09-13): production voice/video E2E passed with real RTP and forced TURN relay; Go TURN credential and current release health checks pass. Remaining physical-device acceptance is optional, so the code/deployment task is verified.
