...
- Closeout (2026-09-13): server relay resume protocol tests and Go full suite pass. The remaining page-refresh/OPFS persistence concern belongs to the separate direct-to-disk task, so this server protocol slice is verified.
