...
- Closed 2026-09-13: all five acceptance criteria are covered by source tests, build checks, relay/CDP browser evidence, and visible Edge+Chrome verification.
- Native save-dialog completion remains optional follow-up evidence, not an acceptance blocker.
